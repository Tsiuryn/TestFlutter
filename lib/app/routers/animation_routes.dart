...
Map.fromEntries(basicDemos.map((demo) => MapEntry(demo.route, demo.builder)));

final miscDemoRoutes =
Map.fromEntries(miscDemos.map((demo) => MapEntry(demo.route, demo.builder)));
