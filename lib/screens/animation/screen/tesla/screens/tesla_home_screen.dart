...
import 'package:test_flutter/screens/animation/screen/tesla/home_controller.dart';
import 'package:test_flutter/screens/animation/screen/tesla/models/TyrePsi.dart';

import '../constantns.dart';
...
class TeslaHomeScreen extends StatefulWidget {
  static const  id = 'TeslaHomeScreen';
  TeslaHomeScreen({Key? key}) : super(key: key);

  @override
  State<TeslaHomeScreen> createState() => _TeslaHomeScreenState();
}

class _TeslaHomeScreenState extends State<TeslaHomeScreen> with TickerProviderStateMixin {
                    ...
                    return Stack(
                      ...
                      children: [
                        ...
                        Opacity(
                          ...
                          child: SvgPicture.asset(
                            "assets/tesla/icons/Battery.svg",
                        ...
                        Positioned(
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: _controller.isCoolSelected
                                ? Image.asset(
                                    "assets/tesla/images/Cool_glow_2.png",
                                    key: UniqueKey(),
                                    width: 200,
                                  )
                                : Image.asset(
                                    "assets/tesla/images/Hot_glow_4.png",
                                    key: UniqueKey(),
                                    width: 200,
                                  ),
                          ),
