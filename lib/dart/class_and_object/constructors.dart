...
class Human {
  ...
  Human.undefined() : this("undefined", 18); // этот конструктор вызывает дефолтный - 3-й

  Human.fromName(String name) : this(name, 18); // этот конструктор вызывает дефолтный - 3-й
